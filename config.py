...
class Settings(BaseSettings):
    ...
    system_prompt: str = Field(
        ...
        "- اكتب ردودك باللغة العربية الفصحى الصحيحة، بدون أخطاء لغوية.\n"
        "- اكتب ردودك كاملة ومفصلة، واترك البوت يختار الطول المناسب حسب السؤال.\n"
        "- إذا كان السؤال بسيطاً، اكتب رداً مختصراً ومفيداً.\n"
        "- إذا كان السؤال معقداً، اكتب رداً مفصلاً وشاملاً.\n"
        "- استخدم لغة عربية مهذبة وواضحة ومناسبة للعملاء.",
        env="SYSTEM_PROMPT"
    )
